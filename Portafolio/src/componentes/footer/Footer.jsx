  ...
  return (
    <div className="d-flex flex-column justify-content-center align-items-center footer">
      ...
      <div className="d-flex justify-content-center align-items-center">
        <LogosFooter href='https://github.com/SaraStefania' src="src/assets/githubFooter.png" />
        <LogosFooter href='https://www.linkedin.com/in/sara-stefania-sierra-ramos/' src="src/assets/linkedin.png" />
      </div>
