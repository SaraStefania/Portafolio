  ...
  return (
    <div id='proyectos' className='container-proyectos'>
        ...
        <div className='d-flex flex-wrap proyectos'>
          <Tarjetas href2='https://portafolio-theta-gilt.vercel.app/' href1='https://github.com/SaraStefania/Portafolio' titulo='Portafolio' src='/assets/portafolio.png'></Tarjetas>
          ...
          <Tarjetas href2='https://www.npmjs.com/package/md-links-minder' href1='https://github.com/SaraStefania/DEV003-md-links' titulo='Md Links' src='/assets/mdLinks.png'></Tarjetas>
          ...
          <Tarjetas href2='https://sarastefania.github.io/DEV003-card-validation/src/index.html' href1='https://github.com/SaraStefania/DEV003-card-validation' titulo='Card Validation' src='/assets/cardValidation.png'></Tarjetas>
        </div>
    </div>
  )
}
